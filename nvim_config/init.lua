...
vim.g.have_nerd_font = false -- Set this to true if you have a Nerd Font
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      -- [[ Configure Telescope ]] See `:help telescope`, `:help telescope.setup()`
  ...
  { 'folke/lazydev.nvim', ft = 'lua', opts = { library = { { path = '${3rd}/luv/library', words = { 'vim%.uv' } } } } },
  {
    ...
    dependencies = {
      { 'williamboman/mason.nvim', opts = {} }, -- Must run before mason-lspconfig
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local function client_supports_method(client, method, bufnr)
            return (vim.fn.has 'nvim-0.11' == 1 and client:supports_method(method, bufnr)) or client.supports_method(method, { bufnr = bufnr })
          end
      ...
      local ensure_installed_tools = {
        ...
        -- Python
        'pyright', -- LSP
        'ruff-lsp', -- LSP (includes linter/formatter)
        -- Bash
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua' },
        python = { 'ruff_format', 'ruff_fix' }, -- Use ruff for both formatting and fixing
  ...
  -- Import custom plugins if defined
...
-- The line below is related to `:help nvim-treesitter-incremental-selection-mod`
-- It cannot be included in the lazy.nvim setup above.
-- require('nvim-treesitter.configs').setup { incremental_selection = { enable = true } }
