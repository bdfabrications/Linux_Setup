...
return {
  ...
  config = function()
    ...
    require('mason-nvim-dap').setup {
      ...
      automatic_installation = true, -- Automatically install adapters listed below
      ...
      ensure_installed = {
        -- Update this list with debug adapters for languages you use
        'delve', -- Go debugger
    ...
    -- Install language-specific dap configurations
    require('dap-go').setup { delve = { detached = vim.fn.has 'win32' == 0 } }

    -- Add other language configs here, for example Python:
    require('dap-python').setup 'python' -- Installs default config for python using debugpy
  end,
}
